      ...
      <nav className="bg-white sticky top-0 z-50 border-b border-stone-100 shadow-sm">
        <div className="flex justify-between items-center w-full px-6 py-4 max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-3 text-sm text-stone-500">
            ...
            <Link to="/register" className="font-medium hover:underline underline-offset-4" style={{ color: '#5300b7' }}>Register</Link>
          </div>
        </div>
      </nav>
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="w-full max-w-md">
          <div className="mb-10 text-center">
            <span className="inline-block text-xs font-semibold uppercase tracking-widest mb-3" style={{ color: '#5300b7' }}>
              Welcome Back
            </span>
            <h1 className="font-headline text-4xl leading-tight" style={{ color: '#1a1c1c' }}>
              Sign in to your <span className="italic font-normal">workspace.</span>
            </h1>
            <p className="mt-3 text-sm" style={{ color: '#4a4455' }}>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-stone-100 p-8">
            ...
            {error && (
              <div className="mb-5 px-4 py-3 rounded-lg text-sm flex items-center gap-2" style={{ backgroundColor: '#ffdad6', color: '#93000a' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-stone-200 text-sm placeholder:text-stone-400 focus:outline-none transition"
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <Link to="/forgot-password" className="text-xs hover:underline underline-offset-4" style={{ color: '#5300b7' }}>
                    Forgot password?
                  </Link>
                </div>
                <input
            ...
            <div className="mt-6 pt-6 border-t border-stone-100 text-center">
              <p className="text-xs text-stone-400">
                ...
                <Link to="/register" className="font-medium hover:underline underline-offset-4" style={{ color: '#5300b7' }}>
                  Create one
                </Link>
              </p>
            </div>
